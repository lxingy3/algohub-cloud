...
const positiveCues = [
  /\bworked\b/i,
  /\bconnected me\b/i,
  /\brecognized\b.*\bneeded\b/i,
  /\brouted\b.*\bright\b/i,
  /\brouted\b.*\bquickly\b/i,
...
const negativeCues = [
  ...
  /\bnot carry over\b/i,
  /\bnotice\b.*\bonly in english\b/i,
  /\blimited data\b/i,
  ...
  /\bseparate form\b.*\bapproved\b/i,
  /\bnot allowed\b/i,
  /\bno way\b/i,
  /\bdenied\b/i,
  /\bpaused\b/i,
  ...
  /\bweeks\b/i,
  /\bseveral days\b/i,
  /\brouted\b.*\b(maintenance|wrong|different)\b/i,
  /\bnobody contacted\b/i,
  /\bcost\b.*\b(days|weeks|months)\b/i,
...
const themeEvidence = {
  opacity: [
    ...
    /\bnot part of the design\b/i,
    /\bdoes not know\b/i,
    /\bnot told\b.*\bhow\b/i,
    /\bcould not see\b.*\b(score|record|rule|reason)\b/i,
    /\bdo not know\b.*\bhow\b/i,
    /\bdon't know\b.*\bhow\b/i,
    /\bunclear\b.*\bwhy\b/i,
    /\bhow\b.*\b(calculated|decided|made|works)\b/i,
  ],
  positive_experience: [
    /\bconnected me\b/i,
    /\brecognized\b.*\bneeded\b/i,
  ...
  lack_of_recourse: [
    /\bcould not change\b/i,
    /\bcould not adjust\b/i,
    /\bcould not adjust\b.*\bmedical equipment\b/i,
    /\bcould not see\b.*\b(score|record|rule|reason)\b/i,
    /\bnot something\b.*\breview\b/i,
    /\bclosed door\b/i,
    /\bhad to come back\b/i,
  ...
  process_confusion: [
    ...
    /\bnot sure\b/i,
    /\bunclear\b.*\b(process|what|why)\b/i,
  ],
  arbitrary_outcome: [
    /\bkept\b.*\b(low priority|high-risk|label|score)\b/i,
    /\bstayed\b.*\b(record|label|priority)\b/i,
    /\bflag\b.*\bdid not seem to update\b/i,
    /\bstatus kept changing\b/i,
    /\bstatus changed\b/i,
    /\bpriority list\b/i,
    /\blow priority\b/i,
    /\brouted\b.*\b(maintenance|wrong|routine)\b/i,
    /\bwrong\b.*\b(category|station|office|team)\b/i,
    /\bscore\b.*\b(from|came from|decided)\b/i,
    /\bstill treated\b/i,
    /\brandom\b/i,
    /\binconsistent\b/i,
  ],
  ...
  data_accuracy: [
    ...
    /\bdid not count\b.*\bmedical equipment\b/i,
    /\bmedical equipment\b/i,
    /\bnot carry over\b/i,
    /\bunit count\b/i,
    /\bmisrouted\b/i,
    /\brouted\b.*\b(maintenance|wrong)\b/i,
    /\boutdated\b/i,
    /\bincorrect\b/i,
    /\bold record\b/i,
    /\bold address\b/i,
...
async function classifyImpact(text) {
  ...
  const positiveResolution = /\b(priority changed|inspection date appeared|the fix helped|corrected|fixed the category|apologized|right unit|same day|same week)\b/i.test(text);
