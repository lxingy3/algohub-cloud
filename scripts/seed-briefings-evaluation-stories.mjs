...
const stories = [
  ...
  fixture('student-award-correction', 'XZY', 'Student Award', 'School staff restored the meal benefit', 'A staff member corrected a household record and restored eligibility before the next school week.', 'The school portal removed my daughter from the meal program after our household size changed. The message did not explain which field failed. The school office compared the application with the enrollment record, corrected the household count, and restored the benefit before the next Monday.'),
