  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50 text-slate-950">
      ...
      <article className="mx-auto max-w-4xl px-6 py-10">
        <Link href="/stories" className="inline-flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-gray-900">
          <ArrowLeft className="h-4 w-4" />
          Back to Stories
        </Link>

        <section className="mt-5 rounded-lg border border-gray-100 bg-white p-8 pb-4">
        ...
        <section className="mt-6 rounded-lg border border-gray-100 bg-white p-8">
...
function EngagementBar({ testimonyId, eyeOpening, support, commentCount }) {
  return (
    <div className="mb-6 flex flex-wrap items-center gap-2">
      ...
      <span className="inline-flex items-center gap-2 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm font-semibold">
