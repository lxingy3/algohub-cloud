        ...
        <div className="relative overflow-x-auto rounded-xl border-2 border-gray-200 bg-white p-3 pb-5 shadow-lg sm:p-6 sm:pb-8">
          <div className="relative min-w-[760px] pt-4 sm:min-w-[900px]">
            <div className="relative mb-4 h-44 w-full">
              ...
              <div className={`absolute top-[25%] z-20 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center transition-all duration-700 ease-in-out ${toolPosition(step)}`}>
              ...
              <div className={`absolute top-[75%] z-20 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center transition-all duration-700 ease-in-out ${staffPosition(step)}`}>
